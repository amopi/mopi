...
use Amopi\Mopi\BuiltInCommands\ClearCacheCommand;
use Amopi\Mopi\BuiltInCommands\InitializeProjectCommand;
use Amopi\Mopi\BuiltInCommands\ValidateServicesCommand;
...
class Mopi
{
    ...
    public function init($configPath, ConfigurationInterface $configurationInterface, $configCachePath = null)
    {
        ...
        if (!$containerConfigCache->isFresh()) {
            ...
            $builder->addCompilerPass(new MopiCompilerPass(static::class));
            $recursiveSetParameter = function (callable $recursiveCallback,
            ...
            $containerConfigCache->write(
                $dumper->dump(['class' => 'MopiCachedContainer', 'namespace' => __NAMESPACE__]),
                $this->configRelatedResources
            );
        ...
        $this->container = new MopiCachedContainer;
        ...
        //mdebug("Mopi [%s] initialized", static::class);
    }
